  ...
  return (
    <main className="main-content">
      <div className="container">
        <div className="welcome-banner" style={{ background: '#5F6FFF' }}>
          <div className="header">
            <span className="date" id="currentDate">{currentDate}</span>
            <button className="trigger-btn notification-button" onClick={() => setShowSnackbar(true)}>
          ...
          <div className="banner-content">
            <div className="text-container">
              <h1>Get Guidance from <br />
                Your Seniors! 🚀</h1>
              <p>
                Ask your doubts about college, NSAT exam, Interview, and more.
              </p>
            </div>
            <div className="avatar-container" style={{ top: '5.5%' }}>
              <img src={seniorImg} alt="College Student" />
            </div>
          </div>
        </div>
        <div className="container">
