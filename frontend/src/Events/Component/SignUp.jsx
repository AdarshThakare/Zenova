    ...
    <div>
      <main className="main-content">
        <div className="container">
          <div className="signup-welcome-banner">
            <div className="signup-header">
              <span className="signup-date">{currentDate}</span>
              <button
          ...
          <div className="SingUp-Form">
            <h2>Sign up</h2>
            <p>
              New to Zenova? Create your account to register for awesome
              junior-focused events—game nights, QnAs, college tips, and more.
              Discover what's happening and be part of our fun and helpful
